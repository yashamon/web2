...
\begin{problem}
Show that with our definition (basically having fibered
charts so that transition maps are fiberwise linear) each fiber of a vector bundle
...
circle). There is a natural projection $\pi _{}: M \to  S ^{1}$ is this a smooth vector bundle?  
\end{problem}
