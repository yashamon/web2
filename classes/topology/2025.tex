...
5.1: 5,6,7 \\
\subsection*{Hw set 9 for wed}
The book of May, page 20, problem 1 \\ 
Let $D$ be the diagram $X \xrightarrow{f} Y$, in category
$Top$, i.e. a continuous map. Find it's colimit.
% , 4, 6
% 3.2: 7,8,9,12
% \subsection*{Hw set 6 for wed}
% \subsection*{Hw set 7 for wed}
