...
4: Use the Cantor diagonalization argument which we used to prove that the set of sequences ${0,1} ^{\mathbb{N}}$ is not countable to prove that $\mathbb{R}$ is not countable.  
