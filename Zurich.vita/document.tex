...
28049 Madrid SPAIN \\
% \textbf{email}: savelyev@math.umass.edu \\
...
2011 \\ Posdoctoral Fellow, MSRI, spring 2010\\
Postdoctoral Fellow CRM-Montreal, August 2011- August 2013\\
Postdoctoral Fellow, ICMAT, Madrid,  current \\
\section{\sc Research interests} Symplectic and differential geometry, especially Gromov-Witten and Floer theory, mathematical physics, dynamical systems, and various interactions of these subjects.  
\section {\sc Publications, Preprints and works in progress, (links available
on my website)} {\em {Quantum characteristic classes
...
\emph{Global Fukaya category and the space of $A _{\infty} $ categories I}, arxiv preprint 2013 \\\\
\emph {Yang Mills theory and jumping curves}, arxiv preprint 2013 \\\\ 
\emph {Global Fukaya category and the space of $A _{\infty} $ categories II}, arxiv preprint, 2014 \\\\
\emph {Non degenerate volume preserving diffeomorphisms of $S ^{2} $ and the
injectivity radius conjecture}, arxiv preprint, 2014 \\\\
...
Electronic Research Announcements, (accepted) 2014 \\\\
\emph {Not ready for publication but I am about to finish the second one}: \\\\
{Spectral geometry of the group of Hamiltonian diffeomorphisms},}  arxiv preprint, 2011\\\\
 {\em {On
configuration spaces of stable maps}}, arxiv preprint, 2011 \\\\ 
\section {\sc Service}
...
CRM-Montreal postdoctoral fellowship,  2011-2013\\ ICMAT Madrid postdoctoral fellowship, current 
...
UW Madison, geometry-topology seminar, 2009. \\\\
...
ICMAT, Madrid 2013 (a series of lectures) \\\\
...
calculus, and graduate algebraic topology (a couple of times). 
...
%  Michael Sullivan, University of Massachusets, Amherst \\
%  Yael Karshon, University of Toronto \\4
