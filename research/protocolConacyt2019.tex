...
We propose that the analogue of a Reeb orbit, and hence of a generator of $\lcs$ homology of $M$, is a $A _{\omega} $-flat, $J _{\omega} $-holomorphic elliptic curve in $M$. Instantons (without compactifications) in this homology theory theory are $J _{\omega} $-holomorphic cylinders in $$ $$
