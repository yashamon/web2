...
\begin{corollary} Assuming the above conjecture given a smooth family $f: S ^{1}  Cont (C)$, with $Cont (C)$  the space of contact forms on $C$, i.
e. $1$-forms $\lambda$ such that $\lambda \wedge \lambda ^{2n} $
\end{corollary}
