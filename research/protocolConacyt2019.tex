...
\subsection {Goal 4.b} Use $CSH (M)$ to prove $\lcs$ non-squeezing, as in Goal 2.a.  \bibliographystyle{siam}  \bibliography{/home/yasha/texmf/bibtex/bib/link} % \bibliography{/root/texmf/bibtex/bib/link} 
\end{document}
