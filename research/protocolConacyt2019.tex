...
Instantons (without compactifications) in this homology theory theory are $J _{\omega} $-holomorphic cylinders in $M$, which are asymptotic in appropriate sense to calibrated elliptic curves. When $M$ is the Banyaga $\lcs$ structure this homology theory becomes identified with contact homology.
