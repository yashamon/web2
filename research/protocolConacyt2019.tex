...
\section {An $\lcs$-homology theory} The above approach via Seiberg-Witten theory is very partial, we need $C$. For general $\lcs$-manifolds we need to develop an analogue of contact homology.
