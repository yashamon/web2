...
\end{example}
Using above we may then  faithfully embed the category of contact manifolds, and contactomorphism  into the category of $\lcsm$'s, and \textbf{\emph{loose}} $\lcs$ morphisms. These can be defined as diffeomorphisms $\phi: (M _{1} , \omega _{1} ) \to (M _{2}, \omega _{2}  ) $ s.t. $\phi ^{*} \omega _{2}= f \cdot \omega _{1} $, for a positive function $$   Note that when $\omega _{i} $ are symplectic this is just a global conformal symplectomorphism by Moser's trick.
