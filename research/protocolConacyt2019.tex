...
This gives background for the outlined research proposal, outlines methods and ideas, as well as further questions and directions. This is a multi-year protocol, and it is possible that we can do everything that is proposed here in two years. However we expect to progress on Goals 1, 2a, and 3.
...
When $M$ is the Banyaga $\lcs$ structure we naturally have $$CSH (M) = CH (M).
 $$
\subsection {Goal 4}  Develop the homology theory $CSH (M)$, and use this to do prove $\lcs$ non-squeezing, as in Goal 2.a.  
