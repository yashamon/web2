...
\subsection {Goal 2.a
}  Remove the condition in the theorem above that $\phi _{*} $ preserves $\Sigma _{i} $. With this condition removed we obtain a simple and direct extension of the original Gromov non-squeezing to $\lcs$ manifolds.
