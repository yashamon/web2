...
This gives background for the outlined research proposal, outlines methods and ideas, as well as further questions and directions. This is a multi-year protocol, and it is possible that we can do everything that is proposed here in two years. However in the first two years we expect to do at least partially Goals 1, 2a, and 4, which are described in the following.
