...
\begin{question} \label{quest:rect} Suppose $S$ that is rectifiable in the sense of measure theory, does the conclusion of the conjecture hold in this case?
   \end{question}
If $S$ is locally rectifiable, then there are powerful additional tools at our disposal, most, most important of which is Sullivan's theory \cite{cite:} which develops a connection between measure theory, and Hahn-Banach theorem with dynamics.
