...
This is an ambitious problem, but we could also set some near term goals. For example we can at first restrict to homotopies $\{X _{t} \}$ of vector fields where the space of orbits $$ is well behaved, for example 
