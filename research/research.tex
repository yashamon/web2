...
My most recent work is in a number of research directions. For example, I am researching rigidity phenomena in locally conformally symplectic geometry as partly initiated by my recent work \cite{citeSavelyevConformalSymplectic}. Locally conformally symplectic manifolds of $\lcs$ manifolds for short, are an extremely natural generalization of both contact and symplectic manifolds.
