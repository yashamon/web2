...
My most recent work is in a number of research directions. For example, I am researching rigidity phenomena in locally conformally symplectic geometry as partly initiated by my recent work \cite{citeSavelyevConformalSymplectic}. Particularly I am interested in extensions of contact and symplectic Gromov non-squeezing theorems to locally conformally symplectic setting.
 This is a relatively new  subject, but has the potential to become big, as it has a number of connections to other branches of differential geometry and dynamical systems.  I am also working towards the conjecture on non-existence, or $C ^{0} $-nearby non-existence of sky catastrophes for homotopies of Reeb vector fields.
