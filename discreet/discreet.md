...
2) Show that the set of positive rational numbers is countable. Hint, the  way to do this is to use 1) by finding an injection from positve rationals to the positive integers.
